...
<head>
    ...
    <link rel="stylesheet" href="/assets/scrollreveal/test">
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <div class="button mx-5">
                    <form class="d-flex" role="search">
                        ...
                        <a href="#" class="btn text-decoration-none text-white" style="background-color: #ff8400;">Search</a>
                    </form>
                </div>
            </div>
        </div>
    ...
    <footer class="text-white" style="background-color: #000;">
        <div class="container">
            <footer class="py-5" style="margin-top: 10rem;">
                <div class="row">
                    ...
                    <div class="col-6 col-md-2 mb-3">
                        <h5>Services</h5>
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Conception et planification</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Construction et réalisation</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Gestion de chantier</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Services aux clients</a></li>
                            <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Expertise et innovation</a></li>
                        </ul>
                    </div>
            ...
            <div onclick="window.scrollTo({top: 0, behavior: 'smooth'});" style="height: 50px; width: 50px; background-color: #ff8400; border-radius: 50%; display: flex; justify-content: center; align-items: center; position: fixed; right: 20px; bottom: 20px; cursor: pointer;">
